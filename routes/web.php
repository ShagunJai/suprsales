...
//use App\Http\Controllers\Auth\Login\CustomerlgController;
use App\Http\Controllers\API\CustLoginController;
...
//use App\Http\Controllers\API\CustDashboardController;
...
use App\Http\Controllers\API\EmpAttnController;
use App\Http\Controllers\API\AttnRegularityController;
use App\Http\Controllers\API\newLaunchController;

// Customer OrderSJ//newLaunchController
use App\Http\Controllers\API\customerOrder;
use App\Http\Controllers\API\customerallorderController;
use App\Http\Controllers\API\CreateorderController;


use App\Http\Controllers\API\CreateBeatPlanController;
use App\Http\Controllers\API\BeatPlanController;
use App\Http\Controllers\API\ViewBeatMapController;
use App\Http\Controllers\API\RepBeatController;
...
Route::any('/search', function (Request $request) {
    ...
    // for beat plan
    $values = config('search.beat_plan');
    foreach ($values as $beat_plan) {
        if (strtoupper($q) == strtoupper($beat_plan)) {
            if (isset(Auth::user()->id)) {
                $ids = Auth::user()->emp_id;
                $announcement = Http::get('http://localhost/suprsales_api/Announcement/create_announcement/getAnnouncementByRegion.php?id=' . $ids)->json();
                ...
                if ($count == 1) {
                    return view('createBeatPlan')->with(compact('announcement', 'ann', 'emp', 'task', 'priority', 'task_status', 'team_status'));
                } else {
                    return redirect('error');
                }
            } else {
...
Route::get('createbeatplan/{myplanid}/{myplanname}', [CreateBeatPlanController::class, 'beattable'], function () {
    return redirect()->route('createbeatplan.beattable');
})->name('createbeatplan.beattable');

Route::get('createbeatplan/beatupdate', [CreateBeatPlanController::class, 'beatupdate'])->name('createbeatplan.beatupdate');
Route::post('createbeatplan/beatupdate', [CreateBeatPlanController::class, 'store'])->name('createbeatplan.store');


// //Customer
//Route::any('customerlogin/', [LoginCustController::class, 'login'])->name('customerlogin.login');
//Route::any('customerlogin/logout/', [LoginCustController::class, 'logout'])->name('customerlogin.logout');
...
Route::any('userlogin/storee/', [userLoginController::class, 'storee'])->name('userlogin.storee');
...
// Customer Order SJ
Route::get('corder/{corder}', [customerOrder::class, 'show'], function () {
	return redirect()->route('corder.show');
})->name('corder.show');




// Route::put('createbeatplan/{edit}', [CreateBeatPlanController::class, 'edit'], function () {
// 	return redirect()->route('custallorder.edit');
// })->name('custallorder.edit');


Route::post('corder/{orderr_id}/{a}', [customerOrder::class, 'approve'], function () {
	return redirect()->route('corder.approve');
})->name('corder.approve');
Route::put('custallorder/{orderss}/{pqr}', [customerallorderController::class, 'update'])->name('custallorder.update');

// Route::get('createorder', [CreateorderController::class], function () {
// 	return redirect()->route('createorder');
// })->name('createorder');


Route::get('custallorder/{custallorder}', [customerallorderController::class, 'show'], function () {
	return redirect()->route('custallorder.show');
})->name('custallorder.show');
Route::get('createbeatplan/{reptsplann}/{start_date}/{pqr}', [CreateBeatPlanController::class, 'edits'], function () {
    return redirect()->route('createbeatplan.edits');
})->name('createbeatplan.edits');

Route::put('createbeatplan/{updatedate}/{reptsid}', [CreateBeatPlanController::class, 'update']);

Route::POST('createorder/{skuu_id}/{Total_sku_value}', [CreateorderController::class, 'store']);

// Customer Order SJ
Route::apiResource('corder', customerOrder::class);
Route::apiResource('custallorder', customerallorderController::class);
Route::apiResource('createorder', CreateorderController::class);


Route::apiResource('newproductlaunch', newLaunchController::class);
Route::apiResource('viewbeatmap', ViewBeatMapController::class);
Route::apiResource('regularity', AttnRegularityController::class);
Route::apiResource('empatten', EmpAttnController::class);
...
//Route::apiResource('customerlogin', LoginCustController::class);




Route::apiResource('home', customerdashboardController::class);
Route::apiResource('custlogin', CustLoginController::class);
...
//Route::apiResource('custdashboard', CustDashboardController::class);
...
Route::apiResource('createbeatplan', CreateBeatPlanController::class);
Route::apiResource('beatplan', BeatPlanController::class);
Route::apiResource('reptsbeatview', RepBeatController::class);


//Route::get('createbeatplan','createBeatPlan');
...
Route::prefix('customer')
    ->as('customer.')
    ->group(function() {
        Route::get('home', [Home\CustomerlgController::class, 'index'])->name('home');

        //Route::get('home', 'Home\CustomerHomeController@index')->name('home');
Route::namespace('Auth\Login')
      ->group(function() {
        Route::get('login', [CustomerlgController::class, 'showLoginForm'])->name('login');
        Route::post('login', [CustomerlgController::class, 'showLoginForm'])->name('login');
        Route::post('logout', [CustomerlgController::class, 'showLoginForm'])->name('logout');
