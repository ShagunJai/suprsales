...
class DashboardController extends Controller
{
	...
	public function index()
	{
        ...
        // It is for 16 days order cycle
			...
			if ($count == 1) {
				return view('dashboard')->with(compact('announcement', 'ann', 'user', 'currentSales', 'currentClaim', 'currentTicket', 'quat_sales', 'mon_sales', 'top_dist', 'top_prod', 'top_plant', 'mon_tic', 'Task', 'task_det'));
			} else {
