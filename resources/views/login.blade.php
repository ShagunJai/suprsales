...
<head>
  ...
  {{-- This is the 1st page as login page --}}
...
{{-- This is use for background picture of the login page --}}
...
{{-- It is chck for the user is  authenticate by the id --}}
...
@if ($message = Session::get('message'))
   ...
   <div class="card-header p-0 pt-1">  
                ...
                &nbsp&nbsp&nbsp<li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Employee Log In</a>
                  </li>&nbsp&nbsp&nbsp
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">Customer Log In</a>
                  </li>
   ...
   <div class="tab-content" id="custom-tabs-one-tabContent">
      ...
      <form class="form-horizontal" action="{{route('userlogin.store')}}" method="POST">
       ...
       <input name="toknow" id="toknow" type="hidden" class="form-control" value="Employee">
        ...
        {{-- This tab is for remember tab with the checkbox --}}
        <div class="row">
          <div class="col-8">
          ...
          <!-- /.col -->
          <div class="col-4">
            {{-- This is the sign in btn use to sign in calling myFunction() --}}
    ...
    <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
	  ...
	  <form class="form-horizontal" action="{{ route('userlogin.store') }}" method="POST">
        ...
        <div class="input-group mb-3">
          <input name="emp_id" class="form-control" placeholder="Customer ID">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-user-tie"></span>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-4">
            {{-- This is the sign in btn use to sign in calling myFunction() --}}
            <button type="submit" onclick="inFunction()" class="btn btn-primary btn-block">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>                  
...
{{-- This is the form used for the login tab  route to userlogin page--}}
...
$userlogin = 1;
@endphp
{{-- This is for the mobile .APK download from the store  --}}
<div class="mobapp">
...
<script src="{!! asset('suprsales_resource/plugins/toastr/toastr.min.js') !!}" type="text/javascript"></script>
	<script>
        // userAgent property is used for returning the user-agent header's value sent to the server by the browser.
 function myFunction() {
