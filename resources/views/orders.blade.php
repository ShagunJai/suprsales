...
{{-- It will show after clicking All Order inside the Sales sidebar --}}
 <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
		  ...
		  <div class="row">
            <h1>Sales Order</h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         {{-- It will store the Authorized EMP_ID and it route the asale with respective ids --}}
			@php
         ...
         {{-- This function can be used to generate the hidden input field in the HTML form --}}
			 ...
			 {{ method_field('PUT') }}
           {{-- It contain all orders define by the start date,end date employee and the status  --}}
           {{-- $order define in the AdminSalesController.php --}}
			 @isset($order)
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                {{-- it gives the link for the home btn in the top --}}
...
{{-- This form is for searching the oder by the employee name  --}}
         <form class="form-horizontal" action="{{route('asales.store')}}" method="POST">
			 {{ csrf_field() }}
            <div class="row">
           {{-- It shows the Employee tab in the top in which we are using dropdown from which we are selecting enployee name and It will get --}}
              <div class="col-md-3">
...
{{-- This is the table shown after clicking All order  --}}
			  <div class="card-body">
