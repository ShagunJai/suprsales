...
@endif
{{-- This is for All Stocks inside the sidebar product tab  --}}
 <section class="content-header">
    ...
    <section class="content">
      <div class="container-fluid">
     {{-- this form is route the request to the stock store --}}
	   <form action="{{route('stock.store')}}" method="POST">
		 <div class="row">&nbsp;&nbsp;
             {{-- this function is used to generate the hidden value inside the store  --}}
			 {{ csrf_field() }}
			 <div class="col">
		<div class="form-group">
               {{-- this tab is use for selecting the plant by dropdown with the plant description as we select the data send to as plant id --}}
                  <select class="form-control select2"  name="plant" data-dropdown-css-class="select2-teal" style="width: 100%;">
                    <option selected="selected" value="null" disabled>Select Plant</option>
                     @isset($plant)
					 @foreach ($plant as $values)
					<option value="{{ $values['PLANT_ID'] }}">{{ $values['PLANT_DESCRIPTION'] }}
					</option>
					@endforeach
					@endisset
                  </select>
	        ...
	        <div class="col">
		<div class="form-group">
               {{-- this tab is use for selecting the Region by dropdown with the region name as we select the data send to as region id --}}

                  <select class="form-control select2"  name="region" data-dropdown-css-class="select2-teal" style="width: 100%;">
                    <option selected="selected" value="null" disabled>Select Region</option>
                     @isset($region)
		...
		<div class="form-group">
        {{-- this is for submit btn to select pland with the region --}}
 ...
 {{-- It is the table head in  row wise inside All Stocks  --}}
			  <div class="card-body">
