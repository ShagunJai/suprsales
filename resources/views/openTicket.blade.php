...
@endif
 ...
 <section class="content">
      <div class="container-fluid">
        <form class="form-horizontal" action="{{route('openticket.store')}}" method="POST">
			 {{ csrf_field() }}
            <div class="row">
    ...
    <div class="card">
			  ...
			  <table id="openticket" class="table table-bordered table-hover" >
			  <thead>
                  <tr>
				  <th>Ticket No.</th>
				    <th>Description</th>
            ...
            <tr>
			 <td>
					 @php
			$openticket = $values['TICKET_ID'];
			@endphp
					<a class='btn btn-warning btn-app btn-xs' href="{{ url('openticket/' . $openticket . '/' . $start_date . '/' . $end_date) }}" style="height:25px; max-width:1%; padding-left:0px; padding-right:0px;" title='View Ticket Details'>
