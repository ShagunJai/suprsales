...
@endif
 ...
 <section class="content">
    ...
    <div class="card">
			...
			@endphp
					<a class='btn btn-warning btn-app btn-xs' href="{{ route('ticket.show',$ticket)}}" style="height:25px; max-width:1%; padding-left:0px; padding-right:0px;" title='View Ticket Details'>
