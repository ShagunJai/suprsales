         ...
         {{-- for each ann as value and the value of respective iten stored as auth_reference so that we can use auth_reference throughout the program --}}
		  ...
		  @if($count==0)
            ...
            <ul class="nav nav-treeview">
                {{-- for each ann as val we check the auth_reference is adminn to access all admins --}}
			@foreach ($ann as $val)
			@if($val['auth_reference'] == 'adminn')
			 ...
			 @endif
                {{-- for each ann as val we check the auth_reference is empss to access all All Employees --}}
			 ...
			 @endif
             {{-- for each ann as val we check the auth_reference is createemployee to access all Create Employee --}}
			 @if($val['auth_reference'] == 'createemployee')
			  ...
			  @endif
             {{-- for each ann as val we check the auth_reference is assignplant to access all Assign Region --}}
		  ...
		  @endif
             {{-- for each ann as val we check the auth_reference is changelevel to access Level --}}
...
{{--------------------------------------------Attendance--------------------------------------------------}}
           ...
           {{-- counter incriment --}}
			...
			@foreach ($ann as $val)
             ...
             @if($val['auth_reference'] == 'empatten')
              <li class="nav-item">
                <a href="empatten" class="nav-link">
        ...
        @if($val['auth_reference'] == 'regularity')
              <li class="nav-item">
                <a href="regularity" class="nav-link">
           ...
           {{-- counter incriment --}}
			...
			@foreach ($ann as $val)
			 @if($val['auth_reference'] == 'createbeatplan')
              <li class="nav-item">
                <a href="createbeatplan" class="nav-link">
                  <i class="nav-icon fas fa-plus-square"></i>
			 ...
			 @if($val['auth_reference'] == 'viewbeatmap')
              <li class="nav-item">
                <a href="viewbeatmap" class="nav-link">
...
@php
      ...
      @if($val['auth_reference'] == 'custallorder')
              <li class="nav-item">
                <a href="custallorder" class="nav-link">
...
{{-----------------------------------------------------------------------------------------------------------------}}
	  ...
	  @if($countersss==0)
        ...
        @if($val['auth_reference'] == 'newproductlaunch')
            ...
            <li class="nav-item">
              <a href="newproductlaunch" class="nav-link">
                <i class="nav-icon fas fa-plus-square"></i>
