...
<div class="preloader flex-column justify-content-center align-items-center" style="background-image: url('storage/cloud.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%;">
   ...
   {{-- blade view for logged in users. To display my users name and email --}}
 @php
...
{{-- it will set and store the message for the toastr --}}
  ...
  @endif
{{-- it will set and store the error for the toastr --}}
  ...
  @endif
{{-- it will set and store the info for the toastr --}}
...
{{-- it checks the worning  if there is any then show --}}
  ...
  @endif
  {{-- principally used to define a section in a layout and is constantly used
