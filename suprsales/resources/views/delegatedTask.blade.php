        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Delegated Tasks</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <form role="form-horizontal" action="{{route('task.store')}}" method="POST">
        ...
        @endif
					  ...
					  <td>
				@php
				$delegatedtask  = $value['TASK_ID'];
				@endphp
                       <a class='btn btn-warning btn-app btn-xs' href="{{route('delegatedtask.show',$delegatedtask)}}"  style="padding-top:18px;"  title="View activities">
