...
@if(isset(Auth::user()->id))
 ...
 @php
  ...
  @endphp
    ...
    <li class="nav-item">
	  <a class="nav-link" title="Help" href="http://apps.insecticidesindia.com:8030/faq">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
         ...
         <ul class="nav nav-pills nav-sidebar nav-flat nav-compact flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  @if($count==0)
			...
			@if($val['auth_reference'] == 'adminn')
			 ...
			 @endif 
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/createemployee" class="nav-link">
		  ...
		  <li class="nav-item">
            <a href="http://apps.insecticidesindia.com:8030/assignplant" class="nav-link">
	  ...
	  @if($counters==0)
		  ...
		  @if($val['auth_reference'] == 'mycutomer')
			   <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/mycutomer" class="nav-link">
                  <i class="nav-icon fas fa-users"></i>
                  <p>My Customers</p>
                </a>
              </li>
		  ...
		  <li class="nav-item">
            <a href="http://apps.insecticidesindia.com:8030/verifydistributor" class="nav-link">
             <i class="nav-icon fas fa-user-check"></i>
              <p>
                Verify Distributor
              </p>
	   ...
	   @if($counterss==0)
			...
			@foreach ($ann as $val)
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/myorder" class="nav-link">
                  <i class="nav-icon fas fa-truck"></i>
                  <p>My Orders</p> 
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/regionorder" class="nav-link">
                  <i class="nav-icon fas fa-truck"></i>
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/depotorder" class="nav-link">
                  <i class="nav-icon fas fa-truck"></i>
                  <p>My Depot Orders</p> 
                </a>
              </li>
	   ...
	   @if($salesview==0)
			...
			@if($val['auth_reference'] == 'stock')
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/stocklist" class="nav-link">
                  <i class="nav-icon fas fa-shopping-cart"></i>
                  <p>My Stocks</p>
                </a>
              </li>
		  ...
		  <li class="nav-item">
            <a href="http://apps.insecticidesindia.com:8030/myplant" class="nav-link">
              <i class="nav-icon fas fa-industry"></i>
              <p>
                My Plants
              </p>
		  ...
		  @if($val['auth_reference'] == 'material')
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/material" class="nav-link">
	   ...
	   @if($county==0)
			...
			@if($val['auth_reference'] == 'createclaim')
			  ...
			  <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/allclaims" class="nav-link">
                  <i class="nav-icon fas fa-eye"></i>
                  <p>All Claims</p>
                </a>
              </li>
			  ...
			  <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/rejectedclaim" class="nav-link">
	  ...
	  @if($counteryu==0)
			...
			@if($val['auth_reference'] == 'contactss')
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/conatctview" class="nav-link">
                 <i class="nav-icon fas fa-address-card"></i>
                  <p>My Contacts</p>
                </a>
              </li>
	  ...
	  @if($countery==0)
			...
			@if($val['auth_reference'] == 'myticket')
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/myticket" class="nav-link">
                  <i class="nav-icon fas fa-ticket-alt"></i>
                  <p>My Tickets</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/ticket" class="nav-link">
                 <i class="nav-icon fas fa-eye"></i>
                  <p>All Tickets</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/openticket" class="nav-link">
                 <i class="nav-icon fas fa-user-check"></i>
	  ...
	  @if($tic_comp==0)
			...
			@if($val['auth_reference'] == 'component')
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/component" class="nav-link">
                  <i class="nav-icon fas fa-plus-square"></i>
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/assigncomponent" class="nav-link">
                  <i class="nav-icon fas fa-user-check"></i>
	  ...
	  @if($countersss1==0)
		...
		<i class="nav-icon fas fa-tasks"></i>
			...
			@if($val['auth_reference'] == 'task')
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/task" class="nav-link">
                 <i class="nav-icon fas fa-plus-square"></i>
                  <p>Create Task</p>
                </a>
              </li>
			 ...
			 @if($val['auth_reference'] == 'assigntask')
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/assigntask" class="nav-link">
                  <i class="nav-icon fas fa-user-check"></i>
                  <p>Assigned Tasks</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/delegatedtask" class="nav-link">
                  <i class="nav-icon fas fa-sitemap"></i>
                  <p>Delegated Tasks</p>
                </a>
              </li>
	  ...
	  @if($countersss==0)
			...
			@if($val['auth_reference'] == 'announce')
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/announce" class="nav-link">
                  <i class="nav-icon fas fa-plus-square"></i>
                  <p>Create</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/announcetype" class="nav-link">
                  <i class="nav-icon fas fa-plus-square"></i>
                  <p>Create Type</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/myann" class="nav-link">
                  <i class="nav-icon fas fa-eye"></i>
	  ...
	  @if($arae==0)
			...
			@foreach ($ann as $val)
			 @if($val['auth_reference'] == 'levelsettings')
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/area" class="nav-link">
              ...
              <li class="nav-item">
                <a href="http://apps.insecticidesindia.com:8030/zone" class="nav-link">
